...
| ПС | Платежный сервис для межбанковских переводов (для примера: [сервис X-plat](https://www.x-plat.ru/)). |
...
Далее оплата происходит в 2 этапа:
...
| ----------------------- | -- | ---- | -- |
| Номер телефона  | phone | value | phone |
| Код оператора  | operator | op_code | provider |
...
<cashin>
<payment id="6437282" provider="mts" amount="1000.00">
<field name="phone">9161234567</field>
</payment>
</cashin>
</request>
```
